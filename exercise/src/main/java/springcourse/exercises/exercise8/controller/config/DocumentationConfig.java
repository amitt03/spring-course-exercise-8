package springcourse.exercises.exercise8.controller.config;
...
public class DocumentationConfig extends WebMvcConfigurerAdapter {
    ...
    public ApiDocumentationController apiDocumentationController() {
        ...
        apiDocumentationController.setBaseControllerPackage("springcourse.exercises.exercise8.controller");
        apiDocumentationController.setBaseModelPackage("springcourse.exercises.exercise8.model");
