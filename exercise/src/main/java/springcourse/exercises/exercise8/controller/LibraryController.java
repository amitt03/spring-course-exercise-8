package springcourse.exercises.exercise8.controller;
...
import springcourse.exercises.exercise8.model.Book;
...
public class LibraryController {
    ...
    @ApiOperation(value = "", response = Book.class, httpMethod = "POST", position = 3)
    public Book createBook(@ApiParam(value = "Book data") @Valid @RequestBody Book book) {
    ...
    public void deleteBook(@ApiParam(name = "catalogId", value = "The book catalog id") @PathVariable String catalogId) {
    ...
    public Collection<Book> readBooksByAuthor(@ApiParam(name = "author") @RequestParam String author) {
