...
public class DocumentationConfig extends WebMvcConfigurerAdapter {
    ...
    public ApiDocumentationController apiDocumentationController() {
        ...
        apiDocumentationController.setBaseControllerPackage("springcourse.solutions.exercise8.controller");
        apiDocumentationController.setBaseModelPackage("springcourse.solutions.exercise8.model");
